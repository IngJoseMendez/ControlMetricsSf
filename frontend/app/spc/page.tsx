...
export default function SPCHome() {
  return (
    <div className="p-8 min-h-full bg-gray-50 dark:bg-gray-950">
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Panel de Módulos SPC</h1>
        <p className="text-gray-500 dark:text-gray-400 mt-1">Seleccione un módulo para iniciar el análisis estadístico.</p>
      </div>
