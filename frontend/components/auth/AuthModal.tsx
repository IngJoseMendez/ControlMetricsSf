        ...
        <div className="flex-1 p-8">
          ...
          {tab === 'guest' && (
            <div className="text-center py-6">
              ...
              <div className="inline-flex items-center gap-2 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl px-4 py-3 mb-6 text-amber-700 dark:text-amber-400 text-sm">
